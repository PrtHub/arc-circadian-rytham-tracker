...
export const metadata: Metadata = {
  title: "Sleep Debt Calculator | Free ARC Tool",
  description: "Calculate your cumulative sleep debt over the last 5 days. Find out how much sleep you owe your body and how to recover safely without disrupting your rhythm.",
  ...
  return (
    <div className="bg-black text-white min-h-screen" style={{ fontFamily: "var(--font-geist-sans)" }}>
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-white/10 mb-12">
        <h2 className="text-3xl font-black mb-6 tracking-tighter">What is Sleep Debt?</h2>
        
        <div className="prose prose-invert prose-lg max-w-none">
          <p className="text-zinc-400 leading-relaxed mb-6">
            <strong>Sleep debt</strong> is the difference between the amount of sleep your body biologically needs and the amount you actually get. It is cumulative. If you need 8 hours of sleep per night but only get 6 hours on Monday, you start Tuesday with a 2-hour sleep debt.
          </p>
          <p className="text-zinc-400 leading-relaxed mb-6">
          ...
          <ol className="text-zinc-400 space-y-3 mb-6 list-decimal pl-5">
            <li><strong>Maintain Consistent Wake Times:</strong> Do not sleep in by more than 60 minutes on weekends, even if you are tired.</li>
            <li><strong>Add Sleep at the Beginning:</strong> Go to bed 30-60 minutes earlier than usual rather than waking up later.</li>
            <li><strong>Strategic Napping:</strong> Take a short 20-30 minute power nap before 3:00 PM to take the edge off fatigue without destroying evening sleep pressure.</li>
          </ol>
        </div>
      </section>
