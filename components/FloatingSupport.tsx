...
export function FloatingSupport() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      <div
        className={`w-[300px] sm:w-[320px] transition-all duration-300 origin-bottom-right rounded-2xl bg-[#111] border border-white/10 p-5 shadow-2xl ${isOpen ? "scale-100 opacity-100 translate-y-0" : "scale-95 opacity-0 translate-y-4 pointer-events-none relative -z-10"
          }`}
      >
