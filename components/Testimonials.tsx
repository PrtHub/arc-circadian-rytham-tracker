      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {reviews.map((r, i) => (
            <div
              key={i}
              className="raised-card p-6 flex flex-col justify-between hover:border-(--accent)/40 transition-all hover:-translate-y-1"
            >
              <div className="flex flex-col gap-4">
                ...
                <blockquote className="text-(--fg) text-sm leading-relaxed italic">
                  &ldquo;{r.quote}&rdquo;
                </blockquote>
              </div>
