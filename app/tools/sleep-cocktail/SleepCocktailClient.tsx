    ...
    <main className="max-w-3xl mx-auto px-6 py-20 min-h-[70vh]">
      ...
      <div className="raised-card p-6 sm:p-10 mb-12 shadow-2xl">
        ...
        <div className="sunken-card border border-(--accent)/30 p-6 sm:p-8 relative overflow-hidden">
          ...
          <h3 className="text-xs font-bold uppercase tracking-widest text-accent mb-6 font-mono">Your Customized Sleep Stack</h3>
              ...
              <div key={item.name} className="border-b border-white/5 last:border-b-0 pb-6 last:pb-0">
                ...
                {item.warning && (
                  <div className="mt-3 p-3 bg-red-950/20 border border-(--aura-crash)/30 rounded-xl flex items-start gap-2.5">
                    <span className="text-(--aura-crash) text-sm">⚠️</span>
          ...
          {hasTheanine && (
            <div className="bg-amber-950/20 border border-(--aura-sun)/30 rounded-xl p-4 mb-6 flex items-start gap-3">
              <span className="text-(--aura-sun) text-lg">⚠️</span>
              <div>
          ...
          <div className="border-t border-white/10 pt-4 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-(--fg-muted) font-mono">
            ...
            <span className="font-bold text-accent uppercase tracking-wider">Science-backed dosages</span>
          </div>
        </div>
      </div>
      ...
      <div className="raised-card p-8 text-center mb-12 border-(--accent)/30">
        <h2 className="text-2xl font-bold mb-4 text-white">Track your stack&apos;s efficiency</h2>
