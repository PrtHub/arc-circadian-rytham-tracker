        ...
        <div className="space-y-6 text-(--fg-muted) text-base sm:text-lg leading-relaxed">
          ...
          <div className="space-y-6">
            <div className="raised-card p-6 border-(--accent)/20 rounded-2xl">
              <h4 className="text-xl font-bold text-accent mb-2 flex items-center gap-2">🦁 The Lion (15%)</h4>
              <p className="text-(--fg-muted) text-sm leading-relaxed">Naturally wakes up very early (5 AM - 6 AM) without an alarm. They have massive morning energy and peak cognitive focus before noon, but experience a sharp crash in the late afternoon.</p>
            </div>
            
            <div className="raised-card p-6 border-(--accent)/20 rounded-2xl">
              <h4 className="text-xl font-bold text-accent mb-2 flex items-center gap-2">🐻 The Bear (50%)</h4>
              <p className="text-(--fg-muted) text-sm leading-relaxed">Follows the natural cycle of the sun. They wake up around 7 AM and have a steady energy burn throughout the day, with peak focus hitting mid-morning to early afternoon.</p>
            </div>
            
            <div className="raised-card p-6 border-(--accent)/20 rounded-2xl">
              <h4 className="text-xl font-bold text-accent mb-2 flex items-center gap-2">🐺 The Wolf (15-20%)</h4>
              <p className="text-(--fg-muted) text-sm leading-relaxed">The classic night owl. They struggle immensely to wake up before 9 AM and feel groggy all morning. Their biological peak focus window doesn&apos;t open until late afternoon or late at night.</p>
            </div>
            
            <div className="raised-card p-6 border-(--accent)/20 rounded-2xl">
              <h4 className="text-xl font-bold text-accent mb-2 flex items-center gap-2">🐬 The Dolphin (10%)</h4>
              <p className="text-(--fg-muted) text-sm leading-relaxed">Light, anxious sleepers with irregular rhythms. They often suffer from insomnia and have bursts of nervous energy rather than a steady, predictable curve.</p>
            </div>
          </div>
        </div>
      </section>
