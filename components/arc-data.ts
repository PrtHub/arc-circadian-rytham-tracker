  ...
  offers: [
    {
      ...
      description:
        "22-step diagnostic onboarding, chronotype discovery, and day preview.",
    },
    {
      "@type": "Offer",
      price: "4.99",
      ...
      description: "Auto-renewing weekly subscription. Cancel anytime in App Store.",
    },
    {
      "@type": "Offer",
      price: "39.99",
...
export const jsonLdOrganization = {
  ...
  sameAs: [
    APP_STORE_URL,
    "https://x.com/iPritamX",
    "https://www.instagram.com/arc.sync/",
  ],
};
