  ...
  return (
    <div className="bg-black text-white min-h-screen" style={{ fontFamily: "var(--font-geist-sans)" }}>
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-white/10 mb-12">
        <h2 className="text-3xl font-black mb-6 tracking-tighter">What is Social Jetlag?</h2>
        
        <div className="prose prose-invert prose-lg max-w-none">
          <p className="text-zinc-400 leading-relaxed mb-6">
            <strong>Social jetlag</strong> occurs when your biological time (your body's natural circadian rhythm) is misaligned with your social time (the schedule dictated by your job, school, or weekend plans). 
          </p>
          <p className="text-zinc-400 leading-relaxed mb-6">
          ...
          <p className="text-zinc-400 leading-relaxed mb-6">
            Your brain does not know what a "weekend" is. It relies on consistent environmental cues (light and temperature) to release hormones like cortisol and melatonin. When you shift your schedule on weekends, you delay your body's natural <em>Temperature Minimum</em> and melatonin onset. This is why you cannot fall asleep on Sunday night, leading to massive sleep deprivation on Monday morning.
          </p>
          <p className="text-zinc-400 leading-relaxed mb-6">
