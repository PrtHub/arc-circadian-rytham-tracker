            ...
            <main className="max-w-3xl mx-auto px-6 py-20 relative">
                <header className="mb-16">
                    ...
                    <div className="flex items-center gap-3 mb-6 text-xs font-bold tracking-widest text-accent uppercase font-mono">
                        <span className="px-3 py-1 rounded-full border border-(--accent)/20 bg-(--accent)/10">{post.category}</span>
                    ...
                    <p className="text-(--fg-muted) text-xl leading-relaxed">{post.excerpt}</p>
                </header>
