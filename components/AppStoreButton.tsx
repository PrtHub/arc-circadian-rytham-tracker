...
export function AppStoreButton({ size = "default", location = "unknown" }: AppStoreButtonProps) {
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-3 rounded-2xl bg-accent text-black font-bold transition-all hover:brightness-110 hover:scale-105 active:scale-95 shadow-[0_8px_25px_rgba(0,0,0,0.35)] font-sans ${isLarge ? "px-8 py-4 text-base" : "px-5 py-3 text-sm"
        }`}
    >
      <svg
        viewBox="0 0 24 24"
