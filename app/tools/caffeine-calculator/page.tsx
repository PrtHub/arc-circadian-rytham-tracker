      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-white/10 mb-12">
        ...
        <div className="prose prose-invert prose-lg max-w-none text-(--fg-muted)">
          <p className="leading-relaxed mb-6">
            Caffeine operates like a pharmaceutical with a specific <strong className="text-white">half-life</strong>, typically around 5 to 7 hours for a healthy adult. This means 6 hours after you finish your coffee, exactly half of the caffeine is still active in your bloodstream, blocking adenosine receptors and preventing restorative deep sleep.
          </p>
